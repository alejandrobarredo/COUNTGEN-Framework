...
from jMetalPy.jmetal.core.problem import FloatProblem, BinaryProblem, Problem
from jMetalPy.jmetal.core.solution import FloatSolution, BinarySolution, CompositeSolution, IntegerSolution
