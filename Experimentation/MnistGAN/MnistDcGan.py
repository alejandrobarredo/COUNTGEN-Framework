...
generator = conditional_latent_to_image.LatentToImageConditionalGenerator(
    model_parameters)
discriminator = conditional_discriminator.ConditionalDiscriminator(model_parameters)
