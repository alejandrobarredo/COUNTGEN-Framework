...
from jMetalPy.jmetal.core.observer import Observer
from jMetalPy.jmetal.core.solution import BinarySolution, FloatSolution, IntegerSolution, PermutationSolution
