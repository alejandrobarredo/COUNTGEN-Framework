...
from jMetalPy.jmetal.core.solution import Solution
from jMetalPy.jmetal.operator import BinaryTournamentSelection
from jMetalPy.jmetal.operator.selection import RankingAndFitnessSelection
from jMetalPy.jmetal.util.comparator import Comparator
from jMetalPy.jmetal.util.comparator import SolutionAttributeComparator
