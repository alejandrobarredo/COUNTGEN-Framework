...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        if self.display_id > 0:  # connect to a visdom server given <display_port> and <display_server>
            print('USING VISDOM *********************************************')
            print('Server: ' + str(opt.display_server))
            print('Port: ' + str(opt.display_port))
            print('Env: ' + str(opt.display_env))
            import visdom
            self.ncols = opt.display_ncols
            #self.vis = visdom.Visdom()
            self.vis = visdom.Visdom(server='127.0.0.1',
            port=opt.display_port, env=opt.display_env)
